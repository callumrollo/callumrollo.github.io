...
Want to read more about my rationale? Check out [this blog post]({filename}/articles/financial_transparency.md).
# Salary

In my role as data scientist at VOTO, I receive **63 300 SEK**/month. This is equivalent to **CONV;759600;SEK;[SEK,GBP,USD]** per year at current exchange rates. This high salary is partly a consequence of my migration status. To work in Sweden I require a [blue card](https://ec.europa.eu/home-affairs/policies/migration-and-asylum/legal-migration-and-integration/work/eu-blue-card_en), a visa aimed at attracting high skill professionals to fill a labour market gap. The eligibility for this card includes a [high minimum salary threshold](https://ec.europa.eu/immigration/blue-card/sweden_en).

I pay around 35 % in taxes to the Swedish government, and an additional 5 % on my UK student loan repayments. This leaves me with ~ **CONV;456000;SEK;[SEK,GBP,USD]** in take home pay. 
...
My salary has increased a bit less than inflation in the 5 years I have held this role.
...
In 2023 I bought a flat in Gothenburg, Sweden with a down payment of **CONV;750000;SEK;[SEK,GBP,USD]** and a bank loan of **CONV;2400000;SEK;[SEK,GBP,USD]** I was only able to do this with financial assistance of **CONV;30000;GBP;[GBP,SEK,USD]**  from my parents. in 2026 I sold this apartment for approximately the same price I bought it for, after 3 years of inflation. I now live in a [shared rented apartment]({filename}/articles/hogsboet.md) once more.

I have a workplace pension and ~ **CONV;300000;SEK;[SEK,GBP,USD]** invested in index funds. Though tbh retirement seems pretty unlikely on a burning planet.
...
I have **CONV;45000;GBP;[GBP,SEK,USD]** of student debt in the UK. Currently the interest rate of 7 % means my payments barely cover the interest. Thanks Nick.
